#
#  Be sure to run `pod spec lint CryptoCompareAPI.podspec' to ensure this is a
...
for the best free to use cryptocurrency database."
  ...
  # Or just: s.author    = "Eugene Velizhenkov"
  # s.authors            = { "Eugene Velizhenkov" => "tredasaibot@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Eugene Velizhenkov"
  ...
  s.swift_version = "4.2"
  s.source       = { :git => "git@github.com:tapkain/CryptoCompareAPI.git", :tag => "#{s.version}" }
